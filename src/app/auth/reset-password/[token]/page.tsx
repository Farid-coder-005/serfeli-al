...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password.length < 6) {
      setStatus("error");
      setMessage("Şifrə ən azı 6 simvoldan ibarət olmalıdır");
      return;
    }
    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-center p-4 relative font-sans overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium mt-2">Yeni şifrənizi daxil edin</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isLoading ? (
                  ...
                  <>ŞİFRƏNİ YENİLƏ <ArrowRight size={18} /></>
                )}
              </button>
            </form>
          )}
