...
export default function DashboardPage() {
    ...
    return (
      <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center p-4">
        <div className="bg-white rounded-[3rem] border border-gray-100 p-12 text-center shadow-xl max-w-md w-full">
          ...
          <h2 className="text-2xl font-black text-[#1E3A8A] mb-4">Giriş edilməyib</h2>
          <p className="text-gray-500 mb-8">Dashboard-u görmək üçün zəhmət olmasa daxil olun.</p>
          <Link href="/login" className="inline-flex items-center justify-center w-full py-4 px-6 bg-[#1E3A8A] text-white rounded-2xl font-black uppercase tracking-widest hover:bg-[#1a3275] transition-all shadow-lg active:scale-95">
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] font-sans pb-20 relative overflow-hidden">
      ...
      {/* Hero / Header Section */}
      <section className="bg-gradient-to-br from-[#1E3A8A] to-[#142659] py-20 relative overflow-hidden border-b border-[#1E3A8A]/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="group bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl shadow-[#1E3A8A]/5 hover:shadow-2xl hover:shadow-[#1E3A8A]/10 transition-all relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#166534]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-700"></div>
                <div className="flex items-center justify-between mb-8">
                  <div className="w-14 h-14 bg-green-50 rounded-2xl flex items-center justify-center text-[#166534] shadow-inner group-hover:rotate-12 transition-transform">
                    <Wallet className="w-6 h-6" />
                  </div>
                  <span className="text-[10px] font-black text-[#166534] bg-green-50 px-3 py-1.5 rounded-full tracking-widest">+12% Ay/Ay</span>
                </div>
            ...
            <div className="bg-white rounded-[3rem] border border-gray-100 shadow-xl shadow-[#1E3A8A]/5 p-8 lg:p-12">
              <div className="flex items-center justify-between mb-12">
                <h2 className="text-2xl font-black text-[#1E3A8A] tracking-tight flex items-center gap-3">
                  <Clock className="w-6 h-6 text-[#166534]" /> Son Əməliyyatlar
                </h2>
                <button className="text-sm font-black text-[#166534] hover:text-[#1E3A8A] transition-colors uppercase tracking-widest">Hamısı</button>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-6 bg-gray-50/50 rounded-[2rem] border border-gray-50 hover:bg-white hover:border-gray-100 hover:shadow-lg transition-all group cursor-pointer">
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 bg-white rounded-2xl border border-gray-100 flex items-center justify-center font-black text-[#1E3A8A] shadow-sm transform group-hover:scale-110 transition-transform">
                        {item.store[0]}
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm font-black text-[#1E3A8A] mb-0.5">{item.store}</span>
                    ...
                    <div className="text-right flex flex-col items-end gap-2">
                      <span className="text-lg font-black text-[#166534]">{item.amount}</span>
          ...
          <div className="flex flex-col gap-8 text-center">
            {/* Profile Progress */}
            <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-[#1E3A8A]/5 p-10 flex flex-col items-center">
              <h3 className="text-xl font-black text-[#1E3A8A] mb-8 uppercase tracking-widest">Profil Səviyyəsi</h3>
              <div className="relative w-48 h-48 mb-8 flex items-center justify-center">
                <svg className="w-full h-full transform -rotate-90">
                  <circle cx="96" cy="96" r="88" strokeWidth="12" stroke="#F9FAFB" fill="transparent" className="rounded-full" />
                  <circle cx="96" cy="96" r="88" strokeWidth="12" stroke="#166534" strokeDasharray="552.92" strokeDashoffset="138.23" fill="transparent" strokeLinecap="round" className="transition-all duration-1000 ease-out" />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-5xl font-black text-[#1E3A8A] tracking-tighter">75%</span>
              ...
              <p className="text-sm text-gray-500 font-medium mb-8 leading-relaxed px-4">
                Növbəti seviyyə üçün <span className="text-[#1E3A8A] font-black">250 AZN</span> dəyərində alış lazımdır.
              </p>
              <button className="w-full py-5 bg-gray-50 border border-gray-100 rounded-2xl text-[11px] font-black text-[#1E3A8A] hover:bg-white hover:border-[#1E3A8A]/20 hover:shadow-lg transition-all uppercase tracking-[0.2em]">
                Səviyyəni Yoxla
              </button>
            </div>

            {/* Refer a Friend card */}
            <div className="bg-gradient-to-br from-[#166534] to-[#14532D] rounded-[2.5rem] p-10 text-white shadow-2xl shadow-green-900/20 relative overflow-hidden group">
              ...
              <button className="w-full py-4 bg-white text-[#166534] rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-green-50 shadow-lg shadow-black/10 transition-all flex items-center justify-center gap-3">
