        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-[#FF6B00]/5 p-10 sm:p-12">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-[#FF6B00] text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all hover:bg-[#E64D00] active:scale-[0.98] disabled:opacity-70 disabled:cursor-wait uppercase tracking-widest"
            >
              {isLoading ? (
