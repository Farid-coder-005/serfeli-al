...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[#F9FAFB] flex flex-col items-center justify-center p-4 relative font-sans overflow-hidden w-full">
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#FF6B00]/5 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#FF6B00]/5 rounded-full blur-3xl translate-y-1/2 translate-x-1/2" />
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-[#FF6B00]/5 p-10 sm:p-12">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                ...
                <button 
                  ...
                  className="text-[10px] font-black text-[#FF6B00] hover:underline uppercase tracking-widest flex items-center gap-1"
                >
            ...
            <button 
              ...
              className="w-full py-4 bg-[#FF6B00] text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all hover:bg-[#E64D00] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-widest"
            >
              {isLoading ? (
