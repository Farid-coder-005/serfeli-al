...
export default function PriceAlertModal({
  ...
  const getFeasibility = () => {
    if (targetVal >= currentPrice) return { label: "Artıq bu qiymətdədir!", color: "bg-gray-400", text: "text-gray-500", percent: 100 };
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-md rounded-[2rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        {/* Header */}
        <div className="relative p-8 bg-[#005ea8] text-white">
          <button 
            onClick={onClose}
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 text-3xl font-black text-slate-800 focus:border-[#005ea8] focus:ring-4 focus:ring-blue-50 outline-none transition-all"
                    placeholder="0.00"
                  />
              ...
              <div className="mb-8 p-5 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-xs font-bold text-slate-500">Realizasiya ehtimalı:</span>
                ...
                {feasibility.info && (
                  <div className="flex gap-2 items-start text-[11px] text-slate-500 leading-tight">
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl pl-14 pr-6 py-4 text-sm font-bold text-slate-800 focus:border-[#005ea8] outline-none transition-all"
              ...
              <button
                ...
                className={`w-full py-4 rounded-2xl bg-[#005ea8] text-white font-black uppercase tracking-widest transition-all shadow-lg shadow-blue-200 hover:bg-[#004a85] hover:-translate-y-0.5 active:translate-y-0 ${
