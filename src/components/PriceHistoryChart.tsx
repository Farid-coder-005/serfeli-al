  ...
  if (chartData.length === 0) {
    return (
      <div className="h-[450px] flex flex-col items-center justify-center bg-white rounded-[3rem] border border-dashed border-gray-100">
        ...
        <p className="text-[#1E293B] font-bold uppercase tracking-widest text-[11px]">Məlumat mövcud deyil</p>
      </div>
    );
  }
    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-white/90 backdrop-blur-xl p-5 border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2rem] ring-1 ring-black/[0.03]">
          <p className="text-[10px] font-black text-[#1E293B] uppercase tracking-[0.2em] mb-3 border-b border-gray-100/50 pb-2">
          ...
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="text-[11px] font-black text-[#1E293B] uppercase">AZN</span>
          </div>
    ...
    <div className="w-full space-y-8">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-4">
                <h3 className="text-4xl sm:text-6xl font-black text-[#26496B] tracking-tighter leading-none">
                  {currentPrice}
                  <span className="text-lg sm:text-xl text-[#1E293B] ml-2 uppercase font-black tracking-widest">AZN</span>
                </h3>
      ...
      <div className="flex items-center justify-between px-12 opacity-30 group-hover:opacity-100 transition-opacity duration-700">
        <div className="flex items-center gap-4">
          ...
          <span className="text-[10px] font-black text-[#1E293B] uppercase tracking-[0.5em]">Təhlükəsiz Məlumat bazası</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-[10px] font-black text-[#1E293B] uppercase tracking-[0.5em]">Real-Time Verifikasiya</span>
          <div className="w-1.5 h-1.5 rounded-full bg-orange-600" />
        </div>
      </div>
    </div>
